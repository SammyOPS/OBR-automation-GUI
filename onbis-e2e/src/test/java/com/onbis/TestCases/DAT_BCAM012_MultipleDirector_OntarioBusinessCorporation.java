...
public class DAT_BCAM012_MultipleDirector_OntarioBusinessCorporation extends SOAdminSetup {
    ...
    public void DAT_BCAM012_MultipleDirector_OntarioBusinessCorporation(String browser) throws IOException, InterruptedException, AWTException {


        Reporter.log("-------: DAT_BCAM012_MultipleDirector_OntarioBusinessCorporation -> ");
        ...
        soIncorporateOntarioBusinessCorporationPage.multipleDirectorsAndSave(1);//completeDirectorsAndSave();

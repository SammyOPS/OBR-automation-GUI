...
public class REG_BCAM012_ReviveAnOntarioBusinessCorporation extends SOAdminSetup {
    ...
    public void REG_BCAM012_ReviveAnOntarioBusinessCorporation(String browser) throws IOException, InterruptedException, AWTException {


        Reporter.log("-------: REG_BCAM012_ReviveAnOntarioBusinessCorporation -> ");
        ...
        soIncorporateOntarioBusinessCorporationPage.completeFeePaymentCashIncorporation();
        soIncorporateOntarioBusinessCorporationPage.GeneralDetailsOCNwriteToCSV( ("REG_BCAM012_ReviveAnOntarioBusinessCorporation"));

 ...
 * </p>
 */
public class OnbisCustomReporter implements IReporter {

    private static final boolean OVERWRITE_RESULTS = false; // false

    private static final Logger LOG = Logger.getLogger(OnbisCustomReporter.class);
//    private static String timeZone = "GMT-5";
    ...
    private static SimpleDateFormat sdftime = new SimpleDateFormat("hh:mm:ss a");                          // ("HH:mm:ss a");
    private String dateName = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
    private String outFilename = "ONBIS E2E Test Results - " + System.getenv("ENV")+"_"+dateName +".html";
    private String outFilenameOverwrite = "ONBIS E2E Test Results.html";
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
        ...
        if (OVERWRITE_RESULTS == true) {
            ...
            return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, outFilenameOverwrite))));
        }
        else
    ...
    protected void writeHead() {
        writer.print("<head>");
        writer.print("<title>ONBIS E2E Test Results</title>");
        writeStylesheet();
        writer.print("</head>");
    }
...
//        writer.print("<div id='header'> Reporting Host   Name:     " + getHostName()+"</span></div>");
        ...
        writer.print("<div id='header'> Test Execution OS Name: " + System.getProperty("os.name")+"</span></div>");
//        writer.print("<div id='header'> Test Execution     OS Version:    " + System.getProperty("os.version")+"</span></div>");
        ...
        writer.print("<div id='header'> Test Execution Environment      : " +  System.getenv("ENV")+"</span></div>");
// ++++++++++++++
        writeSuiteSummary();
...
//        DateTimeFormatter format = DateTimeFormatter.ofPattern("dd-MMM-yyyy HH:mm:ss");
    ...
    private void writeOnbisHeader() {
        ...
        writer.print("<div id='header'><img src='images/logo.png' width='128px'><span id='logo'><b>ONBIS E2E Test Results</b></span></div>");
    }
    ...
    protected void writeSuiteSummary() {
        ...
        writer.print("<table>");
        writer.print("<tr>");
        writer.print("<th><b><ins>Test Suite<b></ins></th>");
        writer.print("<th><font color=\"green\"><b><ins>Passed</font color><b></ins></th>");
        writer.print("<th><font color=\"yellow\"><b><ins>Skipped</font color><b></ins></th>");
        writer.print("<th><font color=\"red\"><b><ins>Failed</font color><b></ins></th>");
//        writer.print("<th>Seconds</th>");
        writer.print("<th><font color=\"blue\"><b><ins>D:HH:MM:SS</font color><b></ins></th>");
        writer.print("<th><b><ins>Included Groups<b></ins></th>");
        writer.print("<th><b><ins>Excluded Groups<b></ins></th>");
        writer.print("</tr>");
...
//                writeTableData( decimalFormat.format(millisecondsToSeconds(duration)), "num");
                writeTableData(millisecondsToSecondsToHMmSs(duration),"num");
...
//            writeTableHeader( decimalFormat.format(millisecondsToSeconds(totalDuration)), "num");
            writeTableHeader(millisecondsToSecondsToHMmSs(totalDuration),"num");
    ...
    protected void writeScenarioSummary() {
        ...
        writer.print("<thead>");
        writer.print("<tr>");
        writer.print("<th><b><ins>Class Name<b></ins></th>");
        writer.print("<th><b><ins>Method Name<b></ins></th>");
        writer.print("<th><b><ins>Test Name<b></ins></th>");
        writer.print("<th><b><ins>Test Starts<b></ins></th>");
//        writer.print("<th>Seconds</th>");
//        writer.print("<th><b><ins>D:HH:MM:SS<b></ins></th>");
        writer.print("<th><font color=\"blue\"><b><ins>D:HH:MM:SS</font color><b></ins></th>");
        writer.print("</tr>");
        writer.print("</thead>");
...
//                            .append( decimalFormat.format( millisecondsToSeconds( duration ) ) ).append("</td></tr>");
                            .append( millisecondsToSecondsToHMmSs(duration) ).append("</td></tr>");
                    scenarioIndex++;
...
// +++++
public static String millisecondsToSecondsToHMmSs(long milliseconds) {
...
//            - TimeUnit.SECONDS.toMillis(TimeUnit.MILLISECONDS.toSeconds(milliseconds));
    return String.format("%d:%02d:%02d:%02d", dy, hr, min, sec);
  //  System.out.println(String.format("%d Days %d Hours %d Minutes %d Seconds %d Milliseconds", dy, hr, min, sec, ms));
}
}
